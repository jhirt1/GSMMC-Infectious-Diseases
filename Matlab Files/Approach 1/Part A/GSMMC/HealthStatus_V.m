function [S,H,R,V,Hdays,SARdays, sA,x,y] = HealthStatus_V(N,L,ni, sA)
%===========================================
...
%inv = randperm(N,nv); % pick nv individuals randomly from N to be
% vaccinated
%%V(inv) = 1; % Set the selected individuals to vaccinated
%S(inv) = 0; % So the individual is not susceptible